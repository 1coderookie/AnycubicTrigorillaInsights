...
A Trigorilla Gen V3.0.7 has been spotted in a [Kobra Go](https://1coderookie.github.io/KobraGoNeoInsights/hardware/mainboard/#trigorilla-v_307). Besides a missing connector it's not clear what has been changed compared to the Gen V3.0.6 board - it seems that the MCU and pin assignments are the same though.   
